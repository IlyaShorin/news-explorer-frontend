      ...
      <div>
        <div className="news__caption">
          <p
            className={
              isHovered
                ? "item__tooltip item__tooltip_visible"
                : "item__tooltip"
            }
          >
            {tooltipHandler()}
          ...
          <button
            type="button"
            className={
              props.saved ? "news__delete-button" : "news__save-button"
            }
        ...
        <a
          ...
          href={props.saved ? props.news.link : props.news.url}
        >
          ...
          <p className="news__text">
            {props.saved ? props.news.text : props.news.description}
          </p>
          <p className="news__media">
            {props.saved ? props.news.source : props.news.source.name}
          </p>
        </a>
      </div>
    </li>
